...
def test_workflow_is_read_only_fixed_and_serialized():
    ...
    # The pinned fingerprint supplied to the SSH action is the trust anchor.
    # Do not add a live network keyscan whose output is unauthenticated and was
    # only useful as temporary diagnostics.
