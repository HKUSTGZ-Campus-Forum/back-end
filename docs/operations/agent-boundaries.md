...
These operational boundaries are binding through [AGENTS.md](../../AGENTS.md). Read
[production environment](../production-environment.md), [school runbook](../../deploy/school/README.md), and [SSO](../../CAMPUS_SSO.md)
before changing authentication, deployment, migrations, Nginx, SISN ingest, or
production data. They describe repository policy; installed host state must be checked for the operation.
