...
class FeedbackMergeComment(db.Model):
    __tablename__ = "feedback_merge_comments"
    ...
    parent_comment_id = db.Column(db.Integer, db.ForeignKey("feedback_merge_comments.id"), nullable=True)
    ...
    author = db.relationship(
        "User",
        backref=db.backref("feedback_merge_comments", lazy="dynamic"),
        foreign_keys=[user_id],
    )
    hidden_by_admin = db.relationship(
        "User",
        backref=db.backref("feedback_merge_comments_hidden", lazy="dynamic"),
